...
public class HomePageTC extends TestBase{
	...
	public void validateNewCustomerPage(String name, String gender, String dob,String address, String city,String state, String pin,String telephone, String email) throws InterruptedException {
		...
		ncp.setAllData(name,gender, dob,address, city,state , pin,telephone, email);
		Thread.sleep(3000);
		ncp.resetdata();
